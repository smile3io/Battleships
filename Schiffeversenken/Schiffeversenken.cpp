...
map<MenuID, vector<pair<char, string>>> mData = {
    ...
    {MenuID::OPTIONS, {
        {'1', "Modus"},
        {'2', "Feldgroesse"},
        {'3', "Schiffs Einstellungen"},
        {'4', "KI Schwierigkeit"},
        {'0', "Zurueck"}}},
    {MenuID::SHIPS, {
        {'1', "Anzahl"},
        {'2', "Segelschiff\t2 Felder"},
        {'3', "Zerstoerer\t3 Felder"},
        {'4', "Kreuzer\t4 Felder"},
        {'5', "Schlachtschiff\t5 Felder"},
        {'6', "Sondergroessen"},
        {'0', "Zurueck"}}},
    {MenuID::MODE, {
        {'1', "Normal"},
...
map<MenuID, map<char, action>> mActions = {
    {MenuID::MAIN, {
        {'1', []() {menuStack.push(MenuID::PLAY);}},
        {'2', []() {}},
        {'3', []() {}},
        {'4', []() {menuStack.push(MenuID::PRESETS);}},
        {'0', []() {}}}},
    {MenuID::PLAY, {
        {'1', []() {clearConsole(); cout << custom.fieldSize; for (int i : custom.ships) { cout << endl << i << endl; }}},
        {'2', []() {}},
        {'3', []() {}},
        {'4', []() {}},
        {'0', []() {goback(menuStack);}}}},
    {MenuID::PRESETS, {
        {'1', []() {preset.setPreset(SMALL); goback(menuStack); }},
        {'2', []() {preset.setPreset(MEDIUM); goback(menuStack); }},
        {'3', []() {preset.setPreset(LARGE); goback(menuStack); }},
        {'4', []() {menuStack.push(MenuID::OPTIONS);}},
        {'0', []() {goback(menuStack);}}}},
    {MenuID::OPTIONS, {
        {'1', []() {}},
        {'2', []() {clearConsole(); cout << "Welche Seitenlaenge soll das Feld haben?" << endl;  int size; cin >> size; custom.fieldSize = size; goback(menuStack); }},
        {'3', []() {menuStack.push(MenuID::SHIPS);}},
        {'4', []() {}},
        {'0', []() {goback(menuStack);}}}},
    {MenuID::SHIPS, {
        {'1', []() {}},
        ...
        {'4', []() {}},
        {'5', []() {}},
        {'6', []() {/*?vieleicht auch nicht implemetieren?*/}},
        {'0', []() {goback(menuStack);}}}},
    {MenuID::MODE, {
